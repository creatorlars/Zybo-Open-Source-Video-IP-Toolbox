...
HD_PWD='/home/rob/Documents/Class/ECEC662/Zybo-Open-Source-Video-IP-Toolbox/video_processing_examples/video_gaussian_blur/video_gaussian_blur.runs/impl_1'
cd "$HD_PWD"
