...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../affine_transform_demo.srcs/sources_1/bd/system/ipshared/7dd0/hdl" \
       +incdir+"$ref_dir/../../../../affine_transform_demo.srcs/sources_1/bd/system/ipshared/100a" \
       +incdir+"../../../../affine_transform_demo.srcs/sources_1/bd/system/ipshared/7dd0/hdl" \
       +incdir+"../../../../affine_transform_demo.srcs/sources_1/bd/system/ipshared/100a" \
