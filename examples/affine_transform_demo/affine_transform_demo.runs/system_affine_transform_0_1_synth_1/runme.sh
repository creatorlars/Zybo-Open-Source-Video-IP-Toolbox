...
HD_PWD='C:/ZyboIP/examples/affine_transform_demo/affine_transform_demo.runs/system_affine_transform_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_affine_transform_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_affine_transform_0_1.tcl
