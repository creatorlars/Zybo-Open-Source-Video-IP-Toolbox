...
HD_PWD='C:/Zybo-Open-Source-Video-IP-Toolbox/video_processing_examples/affine_transform_demo/affine_transform_demo.runs/system_vga_sync_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_vga_sync_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_vga_sync_0_0.tcl
