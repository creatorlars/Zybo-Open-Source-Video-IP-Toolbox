...
entity system is
  ...
  attribute CORE_GENERATION_INFO of system : entity is "system,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=system,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=10,numReposBlks=10,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of system is
  ...
  component system_affine_transform_0_0 is
  port (
    clk : in STD_LOGIC;
  ...
  end component system_affine_transform_0_0;
  signal VDDMinus : STD_LOGIC;
  signal Zero_dout : STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  signal cos_45_dout : STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  signal sin_45_dout : STD_LOGIC_VECTOR ( 9 downto 0 );
...
Zero: component system_xlconstant_0_1
     port map (
      dout(9 downto 0) => Zero_dout(9 downto 0)
    );
affine_transform_0: component system_affine_transform_0_0
     port map (
      a_00(9 downto 0) => cos_45_dout(9 downto 0),
      a_01(9 downto 0) => sin_45_dout(9 downto 0),
      a_02(9 downto 0) => Zero_dout(9 downto 0),
      a_10(9 downto 0) => cos_45_dout(9 downto 0),
      a_11(9 downto 0) => cos_45_dout(9 downto 0),
      a_12(9 downto 0) => Zero_dout(9 downto 0),
...
cos_45: component system_xlconstant_0_2
     port map (
      dout(9 downto 0) => cos_45_dout(9 downto 0)
    );
...
sin_45: component system_xlconstant_0_0
     port map (
      dout(9 downto 0) => sin_45_dout(9 downto 0)
    );
