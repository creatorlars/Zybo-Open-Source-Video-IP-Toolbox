...
HD_PWD='C:/Zybo-Open-Source-Video-IP-Toolbox/general_ip/ieee754_fp_multiplier/ieee754_fp_multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ieee754_fp_multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ieee754_fp_multiplier.tcl
