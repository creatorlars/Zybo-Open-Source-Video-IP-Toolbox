...
HD_PWD='C:/ZyboIP/general_ip/affine_transform/affine_transform.runs/affine_block_ieee754_fp_to_uint_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log affine_block_ieee754_fp_to_uint_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source affine_block_ieee754_fp_to_uint_0_1.tcl
