...
HD_PWD='C:/ZyboIP/general_ip/affine_transform/affine_transform.runs/affine_block_ieee754_fp_multiplier_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log affine_block_ieee754_fp_multiplier_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source affine_block_ieee754_fp_multiplier_0_0.tcl
