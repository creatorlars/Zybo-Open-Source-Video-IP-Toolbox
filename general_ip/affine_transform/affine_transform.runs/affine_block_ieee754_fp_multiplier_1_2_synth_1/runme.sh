...
HD_PWD='C:/ZyboIP/general_ip/affine_transform/affine_transform.runs/affine_block_ieee754_fp_multiplier_1_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log affine_block_ieee754_fp_multiplier_1_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source affine_block_ieee754_fp_multiplier_1_2.tcl
