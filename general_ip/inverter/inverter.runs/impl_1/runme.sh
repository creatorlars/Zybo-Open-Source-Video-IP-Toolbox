...
HD_PWD='/home/rob/Documents/Class/ECEC662/Zybo-Open-Source-Video-IP-Toolbox/general_ip/inverter/inverter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log inverter.vdi -applog -m64 -messageDb vivado.pb -mode batch -source inverter.tcl -notrace
