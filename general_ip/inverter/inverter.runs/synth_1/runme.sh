...
HD_PWD='/home/rob/Documents/Class/ECEC662/Zybo-Open-Source-Video-IP-Toolbox/general_ip/inverter/inverter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inverter.vds -m64 -mode batch -messageDb vivado.pb -notrace -source inverter.tcl
