...
HD_PWD='C:/ZyboIP/general_ip/ieee754_fp_to_uint/ieee754_fp_to_uint.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ieee754_fp_to_uint.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ieee754_fp_to_uint.tcl
