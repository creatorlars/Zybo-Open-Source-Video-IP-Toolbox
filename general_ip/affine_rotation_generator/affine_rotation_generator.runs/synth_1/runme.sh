...
HD_PWD='C:/Zybo-Open-Source-Video-IP-Toolbox/general_ip/affine_rotation_generator/affine_rotation_generator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log affine_rotation_generator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source affine_rotation_generator.tcl
