...
HD_PWD='C:/Zybo-Open-Source-Video-IP-Toolbox/general_ip/uint_to_ieee754_fp/uint_to_ieee754_fp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uint_to_ieee754_fp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uint_to_ieee754_fp.tcl
