...
HD_PWD='/home/rob/Documents/Class/ECEC662/Zybo-Open-Source-Video-IP-Toolbox/video_processing_ip/vga_gaussian_blur/vga_gaussian_blur.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_gaussian_blur.vdi -applog -m64 -messageDb vivado.pb -mode batch -source vga_gaussian_blur.tcl -notrace
