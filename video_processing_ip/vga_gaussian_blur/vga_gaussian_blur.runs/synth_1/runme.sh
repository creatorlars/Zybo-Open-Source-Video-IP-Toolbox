...
HD_PWD='/home/rob/Documents/Class/ECEC662/Zybo-Open-Source-Video-IP-Toolbox/video_processing_ip/vga_gaussian_blur/vga_gaussian_blur.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_gaussian_blur.vds -m64 -mode batch -messageDb vivado.pb -notrace -source vga_gaussian_blur.tcl
