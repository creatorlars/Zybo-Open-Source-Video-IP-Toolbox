...
HD_PWD='D:/Users/Rob/Documents/Class/ECEC662/video_processing_ip/zybo_hdmi/zybo_hdmi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_hdmi.vds -m64 -mode batch -messageDb vivado.pb -notrace -source zybo_hdmi.tcl
