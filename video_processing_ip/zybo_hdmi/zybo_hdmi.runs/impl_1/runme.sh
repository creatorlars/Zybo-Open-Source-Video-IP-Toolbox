...
HD_PWD='D:/Users/Rob/Documents/Class/ECEC662/video_processing_ip/zybo_hdmi/zybo_hdmi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_hdmi.vdi -applog -m64 -messageDb vivado.pb -mode batch -source zybo_hdmi.tcl -notrace
