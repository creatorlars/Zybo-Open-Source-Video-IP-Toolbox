...
HD_PWD='D:/Users/Rob/Documents/Class/ECEC662/video_processing_ip/vga_color_test/vga_color_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_color_test.vds -m64 -mode batch -messageDb vivado.pb -notrace -source vga_color_test.tcl
