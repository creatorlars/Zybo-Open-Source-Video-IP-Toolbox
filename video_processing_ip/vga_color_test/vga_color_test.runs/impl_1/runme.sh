...
HD_PWD='D:/Users/Rob/Documents/Class/ECEC662/video_processing_ip/vga_color_test/vga_color_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_color_test.vdi -applog -m64 -messageDb vivado.pb -mode batch -source vga_color_test.tcl -notrace
