...
HD_PWD='C:/Users/minit/git/Zybo-Open-Source-Video-IP-Toolbox/video_processing_ip/csi2_rx/csi2_rx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log csi_rx_4lane.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source csi_rx_4lane.tcl -notrace
