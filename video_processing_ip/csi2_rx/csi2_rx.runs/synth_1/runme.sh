...
HD_PWD='C:/Users/minit/git/Zybo-Open-Source-Video-IP-Toolbox/video_processing_ip/csi2_rx/csi2_rx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log csi_rx_4lane.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source csi_rx_4lane.tcl
