...
HD_PWD='D:/Users/Rob/Documents/Class/ECEC662/video_processing_ip/vga_sync/vga_sync.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_sync.vds -m64 -mode batch -messageDb vivado.pb -notrace -source vga_sync.tcl
