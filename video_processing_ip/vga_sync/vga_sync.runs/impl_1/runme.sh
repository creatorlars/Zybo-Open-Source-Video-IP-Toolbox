...
HD_PWD='D:/Users/Rob/Documents/Class/ECEC662/video_processing_ip/vga_sync/vga_sync.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_sync.vdi -applog -m64 -messageDb vivado.pb -mode batch -source vga_sync.tcl -notrace
