...
HD_PWD='D:/Users/Rob/Documents/Class/ECEC662/zybo-toolbox/video_processing_ip/zybo_vga/zybo_vga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_vga.vdi -applog -m64 -messageDb vivado.pb -mode batch -source zybo_vga.tcl -notrace
