...
HD_PWD='D:/Users/Rob/Documents/Class/ECEC662/zybo-toolbox/video_processing_ip/zybo_vga/zybo_vga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_vga.vds -m64 -mode batch -messageDb vivado.pb -notrace -source zybo_vga.tcl
